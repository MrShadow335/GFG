...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/change-the-string3541/1)

## Solved On
26 Sept 2026 at 09:41 pm

<h2><a href="https://www.geeksforgeeks.org/problems/change-the-string3541/1">Change the Case based on First Character</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 18px;">Given a string <strong>s</strong>, the task is to change the complete string to uppercase or lowercase depending on the case of the first character.</span></p>
