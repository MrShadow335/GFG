...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/stock-span-problem-1587115621/1)

## Solved On
31 Aug 2026 at 01:23 pm

<h2><a href="https://www.geeksforgeeks.org/problems/stock-span-problem-1587115621/1">Stock Span Problem</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size: 14pt;">The stock span problem is a financial problem where we have a series of daily price quotes for a stock and we need to calculate the span of stock price for all days.</span></p>
...
Hence, the output is [1, 1, 2, 4, 5, 1].</span></span></pre>