...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/find-repetitive-element-from-1-to-n-1/1)

## Solved On
23 Sept 2026 at 09:36 pm

<h2><a href="https://www.geeksforgeeks.org/problems/find-repetitive-element-from-1-to-n-1/1">Find Only Repetitive Element from 1 to n-1</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 14pt; font-family: arial, helvetica, sans-serif;">Given an array <strong>arr[]</strong>&nbsp;of size <strong>n</strong>, filled with numbers from <strong>1</strong> to <strong>n-1</strong> in random order. The array has <strong>only</strong> one repetitive element. Return the <strong>repetitive element</strong>.</span></p>
